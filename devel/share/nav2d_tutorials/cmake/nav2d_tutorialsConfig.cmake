...
if("TRUE" STREQUAL "TRUE")
  set(nav2d_tutorials_SOURCE_PREFIX /home/cristina/new_ws/src/SLAM_packages-main/navigation_2d/nav2d_tutorials)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav2d_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cristina/new_ws/src/SLAM_packages-main/navigation_2d/nav2d_tutorials/${idir}'.  ${_report}")
    endif()
