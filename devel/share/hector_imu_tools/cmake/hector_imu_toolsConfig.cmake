...
if("TRUE" STREQUAL "TRUE")
  set(hector_imu_tools_SOURCE_PREFIX /home/cristina/new_ws/src/SLAM_packages-main/hector_slam/hector_imu_tools)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cristina/new_ws/src/SLAM_packages-main/hector_slam/hector_imu_tools/${idir}'.  ${_report}")
    endif()
