...
"""autogenerated by genpy from exp_assignment3/PlanningActionGoal.msg. Do not edit."""
import codecs
import sys
...
class PlanningActionGoal(genpy.Message):
  ...
  _type = "exp_assignment3/PlanningActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','exp_assignment3/PlanningGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = exp_assignment3.msg.PlanningGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = exp_assignment3.msg.PlanningGoal()
